...
MH <- c(2, 5, 2, 5, 4, 2, 0, 2, 2, 4, 6, 2, 8)
Year <- 2007:2019
...
We note that `r round(sum(MH)/sum(NS) * 100, 0)`% of them had wind speeds exceeding 48.9 m/s. An increase of 8 percentage points.
...
Further we note that the 85th quantile wind speed has increased from 48.9 m/s to `r p85ws` m/s which is an increase of `r p85ws - 48.9` m/s and which matches (within the margin of error) an extrapolation by taking the trend of .63 m/s/yr from Table 1 of Elsner et al. (2008) and multipling it by 7 (mid point number of years in a 13-year period). [48.9 + .63 * 7 = 53.3 m/s].
