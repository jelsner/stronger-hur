...
pNA <- ggplot(df) + 
  geom_segment(aes(x = 0, xend = months, y = Early, yend = Late), size = .75) +
...
pWP <- ggplot(df) + 
  ...
  geom_text(label = l12, y = df$Late, x = rep.int(months, ncol(df)), hjust = 0, size = 3) +
  geom_text(label = l11, y = df$Early, x = rep.int(0, ncol(df)), hjust = 1.2, size = 3) +
  geom_text(label = "Years \n1981-2006", x = 0, y = 82, hjust = 1.2, size = 4) +
  geom_text(label = "Years\n2007-2019", x = months, y = 82, hjust = 0, size = 4) 

( pWP <- pWP + ggtitle("Western North Pacific") )
#  ggtitle("Percentile Wind Speeds", subtitle = "North Atlantic Ocean hurricanes [Data Source: IBTrACS v4 (Knapp et al. 2018)]")
```
...
( pEP <- pEP + ggtitle("Eastern North Pacific") )
#  ggtitle("Percentile Wind Speeds", subtitle = "North Atlantic Ocean hurricanes [Data Source: IBTrACS v4 (Knapp et al. 2018)]")
```
...
( pSI <- pSI + ggtitle("Southern Indian") )
#  ggtitle("Percentile Wind Speeds", subtitle = "North Atlantic Ocean hurricanes [Data Source: IBTrACS v4 (Knapp et al. 2018)]")
```
