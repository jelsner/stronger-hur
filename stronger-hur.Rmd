---
title: Increasing Intensity of Strong Atlantic Hurricanes
...
We note that `r round(sum(MH)/sum(NS) * 100, 0)`% of them had wind speeds exceeding 48.9 m/s. An increase of 5 percentage points.
...
Further we note that the 85th quantile wind speed has increased from 48.9 m/s to `r p85ws` m/s which is an increase of `r p85ws - 48.9` m/s and which matches an extrapolation by taking the trend of .63 m/s/yr from Table 1 of Elsner et al. (2008) and multipling it by 7 (mid point number of years in a 13-year period). [48.9 + .63 * 7 = 53.3 m/s].
...
Furthermore we note that 5% of the storms exceeded 60.3 m/s over the earlier period (Table 1, 95th quantile) but has increased to `r (1 - p95) * 100`% over the later period. The 95th quantile wind speed has increased from 60.3 m/s to `r p95ws` m/s consistent with extrapolating the trend [60.3 + .81 * 7 = 66 m/s].
